import { CartesianViewBoxRequired, ChartOffsetRequired, LayoutType, Margin, Size } from 'recharts/types/util/types';
...
export declare const useOffset: () => ChartOffsetRequired;
/**
